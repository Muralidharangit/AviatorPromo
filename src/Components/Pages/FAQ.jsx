              ...
              <div className="h-100 d-flex justify-content-evenly flex-column">
                ...
                <section class="privacy-container px-2 m-0 pt-0">
                  ...
                  <ul>
                    ...
                    <li>
                      <strong>Country</strong> refers to: Puducherry, India
                    </li>
                    <li>
                      <strong>Company:</strong> {APP_NAME} (referred to as
                      either "the Company", "We", "Us" or "Our" in this
                      Agreement) refers to {APP_NAME} Games.
                    </li>
                    <li>
                    ...
                    <li>
                      ...
                      has been created with the help of the Terms and Conditions
                      Generator.
                    </li>
                    <li>
                    ...
                    <li>
                      ...
                      refers to {APP_NAME} Games, accessible from {""}
                      <span className="text-danger">{WEBSITE_NAME}</span>
                    </li>
                    <li>
                  ...
                  <ul>
                    <li>
                      ...
                      respect to the Service, including all implied warranties
                  ...
                  <ul>
                    <li>
                      ...
                      that the original English text shall prevail in the case
                      of a dispute.
                    </li>
                  </ul>
