  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (err.response?.data?.msg) {
        setError(
          err.response.data.msg || "Something went wrong while resending OTP."
        );
      }
          ...
          <div className="section-head">
            ...
            {authType == "static_otp" ? (
              <p className="text-white">
                Your static OTP is: <strong>1234</strong>.<br /> Please enter it
          ...
          {authType !== "static_otp" && (
            <div className="text-center">
              <p className="text-white">
                ...
                <span
                  className={`fw-600 ${
                    timeLeft === 0 ? "text-red" : "text-secondary"
                  }`}
